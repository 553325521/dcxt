    ...
    define(['jqueryUiZh'], function() {
        return [
            ...
            function($scope,$httpService,config,params,$routeParams,eventBusService,controllerName,loggingService) {
            	...
            	$scope.form.EXPLORE_EXPERT_PK=params.expert_pk;
            	//初始化数据
            	$httpService.post(config.findByIdURL,{"EXPLORE_EXPERT_PK":params.expert_pk}).success(function(data) {
            		...
            		$scope.form.EXPERT_RESULT_OPINION=data.data.EXPERT_RESULT_OPINION;
            		$scope.form.EXPERT_OPTION=data.data.EXPERT_OPTION;
            		$scope.form.EXPERT_MARK=data.data.EXPERT_MARK;
            		$scope.$apply();
            		projectInfo();
            		findMemberList();
            		findFileList();
