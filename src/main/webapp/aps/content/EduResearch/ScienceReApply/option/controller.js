            	...
            	$scope.showExp=function(option){		
            		if(option==1){
            			if($scope.form.apply!=null){
                			...
                			var m2 = {
        	        				url:"aps/content/EduResearch/ScienceReApply/applyInfo/config.json?pk="+params.pk,
        	        				contentName:"content",
        	        				size:"modal-lg",
        	        				text:"申请书详情",
        	        				icon:"edit"
            			...
            			if($scope.form.report!=null){
            				eventBusService.publish(controllerName,'appPart.load.modal.close', {contentName:"modal"});
                			var m2 = {
        	        				url:"aps/content/EduResearch/ScienceReApply/reportInfo/config.json?pk="+params.pk,
        	        				contentName:"content",
        	        				size:"modal-lg",
        	        				text:"开题报告详情",
        	        				icon:"edit"
            			...
            			if($scope.form.progress!=null){
            				eventBusService.publish(controllerName,'appPart.load.modal.close', {contentName:"modal"});
                			var m2 = {
        	        				url:"aps/content/EduResearch/ScienceReApply/progressinfo/config.json?pk="+params.pk,
        	        				contentName:"content",
        	        				size:"modal-lg",
        	        				text:"中期报告详情",
        	        				icon:"edit"
            			...
            			if($scope.form.achieve!=null){
            				eventBusService.publish(controllerName,'appPart.load.modal.close', {contentName:"modal"});
                			var m2 = {
        	        				url:"aps/content/EduResearch/ScienceReApply/achieveinfo/config.json?pk="+params.pk,
        	        				contentName:"content",
        	        				size:"modal-lg",
        	        				text:"结题报告详情",
        	        				icon:"edit"
