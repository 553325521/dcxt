	...
	*/
	...
	public void createCard() {
		...
		/*	jsonPost.add(cardJsonObj);*/
			...
			/*装卡券码型*/
			baseInfoInnerJsonObj.put("code_type","CODE_TYPE_TEXT");
			param.put("code_type","CODE_TYPE_TEXT");
			/*装卡券名称*/
			...
			/*装卡券使用提醒*/
			baseInfoInnerJsonObj.put("notice","使用时向服务员出示此券");
			param.put("notice","使用时向服务员出示此券");
			/*装卡券服务电话*/
			baseInfoInnerJsonObj.put("service_phone",reShopMap.get("SHOP_TEL"));
			param.put("service_phone",reShopMap.get("SHOP_TEL"));
			/*装卡券使用说明*/
			baseInfoInnerJsonObj.put("description",map.get("FAVOURABLE_SHARE")+"请在消费时向商户提出\\n"+map.get("SHOP_NAME")+"店内均可使用");
			param.put("description",map.get("FAVOURABLE_SHARE")+"请在消费时向商户提出\\n"+map.get("SHOP_NAME")+"店内均可使用");
			/*装卡券有效期设置*/
			...
			/*设置用户可领取与核销的卡券数量*/
			baseInfoInnerJsonObj.put("use_limit",1);
			baseInfoInnerJsonObj.put("get_limit",1);
			param.put("use_limit",1);
			param.put("get_limit",1);
			/*设置卡券是否可以分享*/
			baseInfoInnerJsonObj.put("can_share",true);
			param.put("can_share",true);
			/*设置卡券是否可以转赠*/
			baseInfoInnerJsonObj.put("can_give_friend",Boolean.parseBoolean(map.get("SHARE_TYPE").toString()));
			param.put("can_give_friend",Boolean.parseBoolean(map.get("SHARE_TYPE").toString()));
			/*设置卡券适用门店*/
